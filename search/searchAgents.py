        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hits_wall:
                ...
                if next_position in self.corners and next_position not in starting_found_corners:
                    ...
                    successors.append(((next_position, starting_found_corners), action, 1))
...
def cornersHeuristic(state, problem):
    ...
    permutations = list(itertools.permutations(list(range(0, corners_remaining))))
...
def foodHeuristic(state, problem):
    ...
    game_state = problem.getGameState()
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState):
        ...
        search_problem = PositionSearchProblem(gameState, start=position, goal=nearest_bite_position, warn=False, visualize=False)
        path = search.bfs(search_problem)
        return path
